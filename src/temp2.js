...
const App = () => {
  ...
  const [idFilter, setIdFilter] = useState({ equals: "", lessThan: "", lessThanOrEqual: "", greaterThan: "", greaterThanOrEqual: "", notEqual: "", rangeMin: "", rangeMax: "" });
  ...
  const handlesearchPC = (e) => setProjectsCompleted(e.target.value);
  const handleSearchAL = (e) => setAccessLevel(e.target.value);

  const handleIdFilter = (e) => setIdFilter({ ...idFilter, [e.target.name]: e.target.value });
  const handleAgeFilterChange = (e) => setAgeFilter({ ...ageFilter, [e.target.name]: e.target.value });
  const handleSalaryFilter = (e) => setSalaryFilter({ ...salaryFilter, [e.target.name]: e.target.value });
  ...
  const applyIntegerFilter = (item, filter) => {
    ...
    return (
      (equals === "" || num === parseInt(equals, 10)) &&
      (lessThan === "" || num < parseInt(lessThan, 10)) &&
      (lessThanOrEqual === "" || num <= parseInt(lessThanOrEqual, 10)) &&
          ...
          <tr>
            <th>ID
              ...
              <div>
                ...
                <input type="text" name="lessThan" placeholder="Less Than" onChange={handleIdFilter} />
                <input type="text" name="lessThanOrEqual" placeholder="Less Than or Equal" onChange={handleIdFilter} />
                <input type="text" name="greaterThan" placeholder="Greater Than" onChange={handleIdFilter} />
                <input type="text" name="greaterThanOrEqual" placeholder="Greater Than or Equal" onChange={handleIdFilter} />
                <input type="text" name="rangeMin" placeholder="Range Min" onChange={handleIdFilter} />
                <input type="text" name="rangeMax" placeholder="Range Max" onChange={handleIdFilter} />
              </div>
            </th>
            <th>Name
              <input
